            ...
            <Navbar expand="lg" className="bg-transparent">
                <Container fluid className="px-5 mx-0 align-items-center ">
                    <div className="d-flex align-items-center"> {/* Adjust alignment classes here */}
                        <NavLink to="/home" className="fs-3 fw-bold text-light"
                    ...
                    <Nav className="d-flex mx-auto justify-content-between align-items-center w-75 ">
                        <div className="d-flex mx-auto">
                            <Navbar.Toggle aria-controls="actions-nav" style={{color: "rgb(206, 124, 0)"}}
                                           className="mt-0 align-self-end"/> {/* Added Navbar.Toggle here */}
                            <Nav>
                        ...
                        <div>
                            ...
                            <NavLink to="" style={{color: "rgb(206, 124, 0)"}}>
                                <FontAwesomeIcon icon={faMagnifyingGlass} className="ms-2 me-2"/>
