...
export default function RoastingDegreeEdit({submitAdd}) {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const res = await axiosInstance.put(`roastingDegree/${id}/`, formInput);
    ...
    return (
        <div className="text-start" style={{color: "var(--gray1)"}}>
            ...
            >
                <h1 className="text-center">Edit roasting Degree </h1>
