  ...
  return (
    <div className="d-flex" style={{margin:"60px", height:"620px" }}>
        <div style={{height:"100%", width:"30%"}} className="m-4">
            <img src={m1} style={{height:"100%", width:"100%"}} className="rounded-5" alt=""/>
        </div>
        <div  className="d-flex" style={{height:"100%", width:"60%"}} >
            <div style={{height:"96%", width:"50%"}} className="m-4">
                <img src={m3} style={{height:"50%", width:"100%"}} className="mb-4 rounded-5" alt=""/>
                <br/>
                <img src={m2} style={{height:"50%", width:"100%"}} className="rounded-5" alt=""/>
            </div>
            <div style={{height:"96%", width:"50%"}} className="m-4">
                <img src={m4} style={{height:"50%", width:"100%"}} className="mb-4 rounded-5" alt=""/>
                <br/>
                <img src={m5} style={{height:"50%", width:"100%"}} className="rounded-5" alt=""/>
            </div>
        </div>
    </div>
